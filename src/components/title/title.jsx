    ...
    return <div className="container">
        <div className="title-container">
            <div className="inner-container">
                ...
                <div className="intro">
                    <p className="intro-1">I am a third year Computer Science undergraduate at National University of Singapore. </p>
                </div>
        ...
        <div className="title-divider">
            <div className="title-down-container">
                <div className="title-down-btn" onClick={() => props.experienceRef.current.scrollIntoView({behavior:"smooth"})}>
