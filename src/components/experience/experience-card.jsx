...
function ExperienceCard(props) {
  ...
  function ExperienceDesc(desc) {
    return (
      <div className="experience-card-desc-line">
  ...
  function ExpeirenceDetail() {
    return (
      <div className="experience-card-detail hide" id={data.id}>
  ...
  return (
    <div className="experience-card-container">
      <div className="timeline experience-card-line">
        <p className="experience-card-circle">
      ...
      <div className="experience-card">
        <div className="experience-card-header">
          ...
          <div className="experience-card-sub">
            <div className="experience-card-company">{data.name}</div>
            <div className="experience-card-date">
              {data.start} - {data.end}
            </div>
            <div onClick={toggleExpand}>
              <i
                class="fa-solid fa-chevron-up experience-expand-btn down"
                id={"experience-expand" + data.id}
              ></i>
            </div>
          </div>
        </div>
